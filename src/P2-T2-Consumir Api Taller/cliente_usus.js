...
function vehiculos_usu() {
    ...
    var identificador = document.querySelectorAll("input")[1].value;
...
function api(api_url) {
  ...
  .then(data => {
    ...
    else if (api_url == 'http://localhost:5000/usuario?id_usuario='+identificador) {
    ...
    if (api_url == "http://localhost:5000/usuarios" && api_url == 'http://localhost:5000/usuario?id_usuario='+identificador) {
